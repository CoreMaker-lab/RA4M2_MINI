...
#define VECTOR_NUMBER_GPT6_CAPTURE_COMPARE_B ((IRQn_Type) 4) /* GPT6 CAPTURE COMPARE B (Capture/Compare match B) */
#define GPT6_CAPTURE_COMPARE_B_IRQn          ((IRQn_Type) 4) /* GPT6 CAPTURE COMPARE B (Capture/Compare match B) */
